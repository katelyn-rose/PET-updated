...
```{r}
# reading in data
pet_data <- read.csv(here("Plant-Trial-main", "data", "plantcodefinal.csv"))
...
month_labels <- c("May", "June", "July", "August", "September", "October", "November", "December", "January", "February", "March", "April", "May", "June", "August", "September", "October", "November", "December", "January", "February", "March", "Apr")

selected_breaks <- c(1, 5, 10, 15, 20, 23)
...
# find averages of appearance score
